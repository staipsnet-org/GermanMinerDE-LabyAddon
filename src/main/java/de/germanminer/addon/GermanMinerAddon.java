...
public class GermanMinerAddon extends LabyModAddon {
    ...
    protected void fillSettings(List<SettingsElement> list) {
        ...
        list.add(new KeyElement("Tempolimiter (aktuelles Tempo übernehmen)", new ControlElement.IconData(VehicleDisplayModule.Texture.SPEED_LIMITER_READY.getResourcePath(false)), VehicleHotkeyListener.Function.SPEEDLIMITER_SET.getHotkey(), key -> {
            if (key < -1)
                key = -1;
